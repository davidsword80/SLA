...
const messages = [
    "5 étoiles :<br>Augmente les dégâts de Compétence de base de l'utilisateur de 20 %.<br>Lors de l'utilisation d'une Compétence de base, les Dégâts de coup critique de l'utilisateur augmentent de 8% pendant 12 seconde(s) (cumulable jusqu'à 6 fois).",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente les dégâts de compétence de base de l'utilisateur de 5%.<br>Lors de l'utilisation d'une compétence de base, les Dégâts de coup critique de l'utilisateur augmentent de 2% pendant 12 seconde(s) (cumulable jusqu'à 6 fois).";  // Message 0 étoile
        } else {
