...
const messages = [
    "5 étoiles :<br>La Défense de l'utilisateur augmente de 12%.<br>Lorsque les compétences Esprit combatif ou Attaque lourde: Esprit combatif touchent leur cible, les dégâts élémentaires de lumière infligés à la cible augmentent de 12% pendant 15 seconde(s).",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>La Défense de l'utilisateur augmente de 4%.<br>Lorsque les compétences Esprit combatif ou<br>Attaque lourde: Esprit combatif touchent leur cible, les dégâts élémentaires de lumière infligés à la cible augmentent de 4% pendant 15 seconde(s).";  // Message 0 étoile
        } else {
