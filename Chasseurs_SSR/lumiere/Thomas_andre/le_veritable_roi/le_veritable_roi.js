...
const messages = [
    "5 étoiles :<br>Augmente la Défense de 16%.<br>Augmente les probabilités d'acquisition de bouclier de 24%.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente la Défense de 4%.<br>Augmente les probabilités d'acquisition de bouclier de 6%.";  // Message 0 étoile
        } else {
