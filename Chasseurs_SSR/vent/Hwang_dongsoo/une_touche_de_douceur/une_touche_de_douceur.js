...
const messages = [
    "5 étoiles :<br>Les dégâts de vent infligés par l'utilisateur augmentent de 12%.<br>Les dégâts de compétence de base de l'utilisateur augmentent de 3% lorsque les effets [Vengeance impulsive ou Folie] s'activent (cumulable jusqu'à 15 fois).",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Les dégâts de vent infligés par l'utilisateur augmentent de 4%.<br>Les dégâts de compétence de base de l'utilisateur augmentent de 3% lorsque les effets [Vengeance impulsive ou Folie] s'activent (cumulable jusqu'à 4 fois).";  // Message 0 étoile
        } else {
