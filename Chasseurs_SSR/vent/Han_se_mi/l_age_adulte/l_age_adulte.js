...
const messages = [
    "5 étoiles :<br>Augmente les PV de l'utilisatrice de 10%.<br>Augmente les dégâts subis de 5% pendant 10 seconde(s) face aux cibles touchées par une compétence de Han Se-Mi.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente les PV de l'utilisatrice de 4 %.<br>Augmente les dégâts subis de 5% pendant 4 seconde(s) face aux cibles touchées par une compétence de Han Se-Mi.";  // Message 0 étoile
        } else {
