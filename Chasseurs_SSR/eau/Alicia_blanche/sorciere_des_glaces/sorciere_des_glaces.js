...
const messages = [
    "5 étoiles :<br>Les dégâts de l'Attaque de noyau de l'utilisateur augmentent de 40%.<br>Lorsque l'effet [Armure de givre] s'active, les dégâts d'eau augmentent de 20% pendant 20 seconde(s). <br>(Temps de rechargement: 30 seconde(s))",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Les dégâts de l'Attaque de noyau de l'utilisateur augmentent de 10%.<br>Lorsque l'effet [Armure de givre] s'active, les dégâts d'eau augmentent de 5% pendant 20 seconde(s). <br>(Temps de rechargement: 30 seconde(s))";  // Message 0 étoile
        } else {
