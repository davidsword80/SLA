...
const messages = [
    "5 étoiles :<br>Augmente la Défense de l'utilisatrice de 12%.<br>Augmente le Taux de coup critique et les Dégâts de coup critique de Prends ça !, Harper! Nous ne faisons qu'un! et Harper! À l'aide ! de 24%.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente la Défense de l'utilisatrice de 2%.<br>Augmente le Taux de coup critique et les Dégâts de coup critique de Prends ça !, Harper ! Nous ne faisons qu'un! et Harper ! À l'aide ! de 4%.";  // Message 0 étoile
        } else {
