...
const messages = [
    "5 étoiles :<br>L'Attaque de l'utilisatrice augmente de 12%.<br>Le Taux de coup critique de l'utilisatrice augmente de 20 %.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>L'Attaque de l'utilisatrice augmente de 2%.<br>Le Taux de coup critique de l'utilisatrice augmente de 10%.";  // Message 0 étoile
        } else {
