...
const messages = [
    "5 étoiles :<br>L'Attaque de l'utilisatrice augmente de 12%.<br>Augmente l'Attaque supplémentaire du membre de l'équipe au Taux de coup critique le plus élevé de 300 point(s) par tranche de 1000 point(s) d'Attaque supplémentaire d'Esil Radir (Le maximum d'Attaque supplémentaire s'élève à 2400).",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>L'Attaque de l'utilisatrice augmente de 4%.<br>Augmente l'Attaque supplémentaire du membre de l'équipe au Taux de coup critique le plus élevé de 300 point(s) par tranche de 1000 point(s) d'Attaque supplémentaire d'Esil Radir (Le maximum d'Attaque supplémentaire s'élève à 600).";  // Message 0 étoile
        } else {
