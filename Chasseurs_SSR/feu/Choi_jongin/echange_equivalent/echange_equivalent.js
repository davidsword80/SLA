...
const messages = [
    "5 étoiles :<br>Augmente l'Attaque de l'utilisateur de 20%.<br>Lorsque des cibles affectées par l'effet [Brûlure] de Choi Jongin sont attaquées, leur Défense diminue de 20% pendant 5 seconde(s).",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente l'Attaque de l'utilisateur de 5%.<br>Lorsque des cibles affectées par l'effet [Brûlure] de Choi Jongin sont attaquées, leur Défense diminue de 7% pendant 5 seconde(s).";  // Message 0 étoile
        } else {
