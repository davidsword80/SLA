...
const messages = [
    "5 étoiles :<br>Augmente la Pénétration de défense de l'utilisatrice de 12%.<br>Augmente les dégâts de Tir mortel, Attaque de noyau et Feu de l'enfer de 24%.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente la Pénétration de défense de l'utilisatrice de 4%.<br>Augmente les dégâts de Tir mortel, Attaque de noyau et Feu de l'enfer de 8%.";  // Message 0 étoile
        } else {
