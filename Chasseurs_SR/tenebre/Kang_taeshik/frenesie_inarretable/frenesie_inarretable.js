...
const messages = [
    "5 étoiles :<br>Augmente les dégâts des attaques dans le dos de l'utilisateur de 10%.<br>Les dégâts de Kang Taeshik face aux cibles affectées par [Hémorragie] augmentent de 10%.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente les dégâts des attaques dans le dos de l'utilisateur de 2.5 %.<br>Les dégâts de Kang Taeshik face aux cibles affectées par [Hémorragie] augmentent de 2.5%.";  // Message 0 étoile
        } else {
