...
const messages = [
    "5 étoiles :<br>Augmente la Défense de l'utilisateur de 8%.<br>Lorsque l'effet [Détermination du père] s'active, un [Bouclier] supplémentaire équivalent à 8% de la Défense de l'utilisateur est créé, et les dégâts de ses Compétences de base augmentent de 35%.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente la Défense de l'utilisateur de 2%.<br>Lorsque l'effet [Détermination du père] s'active, un [Bouclier] supplémentaire équivalent à 2% de la Défense de l'utilisateur est créé, et les dégâts de ses Compétences de base augmentent de 10%.";  // Message 0 étoile
        } else {
