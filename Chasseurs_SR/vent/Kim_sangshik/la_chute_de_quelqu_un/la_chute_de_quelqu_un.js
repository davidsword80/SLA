...
const messages = [
    "5 étoiles :<br>Augmente les dégâts de l'Attaque de noyau de l'utilisateur de 24%.<br>Lors de l'utilisation d'une Attaque de noyau, les dégâts de la prochaine compétence de base de l'utilisateur augmentent de 24%.",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente les dégâts de l'Attaque de noyau de l'utilisateur de 4%.<br>Lors de l'utilisation d'une Attaque de noyau, les dégâts de la prochaine compétence de base de l'utilisateur augmentent de 4%.";  // Message 0 étoile
        } else {
