...
const messages = [
    "5 étoiles :<br>Augmente les dégâts de Compétence ultime de l'utilisatrice de 20%.<br>Lors de l'utilisation de la compétence ultime, les dégâts de Compétence ultime du membre de son équipe ayant la Puissance totale la plus élevée augmentent de 20% pendant 20 seconde(s).",
...
stars.forEach(star => {
    star.addEventListener('click', function () {
        ...
        if (this === stars[0] && firstStarClicked) {
            ...
            message.innerHTML = "0 étoile :<br>Augmente les dégâts de Compétence ultime de l'utilisatrice de 5%.<br>Lors de l'utilisation de la compétence ultime, les dégâts de Compétence ultime du membre de son équipe ayant la Puissance totale la plus élevée augmentent de 5% pendant 20 seconde(s).";  // Message 0 étoile
        } else {
