...
weaponsData["lame-de-razan"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque la compétence <strong>Entaille ardente</strong> touche sa cible, elle lui inflige l'effet <span class="buff">[Brûlure]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Brûlure]</span></h4><p>Inflige des dégâts équivalents à <span class="stat-boost">44 %</span> de l'Attaque toutes les 3 seconde(s) (cumulable jusqu'à 5 fois).<br>Durée : 30 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Les dégâts de la compétence <strong>Entaille ardente</strong> augmentent de <span class="stat-boost">44 %</span> lorsque Jinwoo attaque des cibles affectées par <span class="buff">[Brûlure]</span>.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de feu augmentent de <span class="stat-boost">6 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Augmente les dégâts de brûlure de la compétence <strong>Entaille ardente</strong> de <span class="stat-boost">44 %</span>.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement d'<strong>Entaille ardente</strong> diminue de <span class="stat-boost">10 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Les dégâts infligés aux monstres de type Boss avec <strong>Entaille ardente</strong> augmentent de <span class="stat-boost">44 %</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["epee-longue-en-ecailles-de-dragon"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque l'utilisateur réalise une frappe descendante avec <strong>Entaille du dragon de feu</strong>, il crée un <strong>Domaine du dragon</strong>.<br></p><div class="detail-box"><h4><span class="buff">[Domaine du dragon]</span></h4><p>Réduit de <span class="stat-boost">30%</span> les dégâts subis par les alliés se trouvant dans la zone et ajoute l'effet <span class="buff">[Super armure]</span>.<br>Inflige des dégâts supplémentaires équivalents à <span class="stat-boost">100%</span> de l'Attaque lorsque des attaques touchent leur cible dans la zone (s'active toutes les 2 seconde(s)).<br>Durée: 10 secondes</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Applique l'effet <span class="buff">[Pouvoir du sang de dragon]</span> aux alliés se trouvant dans la zone de <span class="buff">[Domaine du dragon]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Le pouvoir du sang de dragon]</span></h4><p>Augmente l'Attaque de l'utilisateur de <span class="stat-boost">12%</span>.<br>Durée: 10 seconde(s)</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de feu augmentent de <span class="stat-boost">8 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Augmente la zone d'effet et la durée de <span class="buff">[Domaine du dragon]</span> de <span class="stat-boost">50%</span>.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Réduit le temps de rechargement d'<strong>Entaille du dragon de feu</strong> de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Augmente les dégâts de <span class="stat-boost">100%</span> lorsque la compétence <strong>Entaille du dragon de feu</strong> est utilisée dans la zone d'effet de <span class="buff">[Domaine du dragon]</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["grimoire-de-demon-ardent"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque l'utilisateur applique <strong>Éclatement</strong>, les effets <span class="buff">[Insufflation de points de mana]</span> ou <span class="buff">[Récupération de points de mana]</span> s'appliquent selon la quantité de PM restante.<br></p><div class="detail-box"><h4><span class="buff">[Insufflation de points de mana]</span></h4><p>Si les PM de l'utilisateur sont de <span class="stat-boost">51%</span> ou plus, l'effet est activé.<br>Lorsque l'utilisateur applique <strong>Éclatement</strong>, ses dégâts de compétence augmentent de <span class="stat-boost">30%</span>, mais <span class="stat-boost">10%</span> de ses PM max sont consommés.<br></p></div><div class="detail-box"><h4><span class="buff">[Récupération de points de mana]</span></h4><p>Si les PM de l'utilisateur sont de <span class="stat-boost">50%</span> ou moins, l'effet est activé.<br>L'utilisateur récupère <span class="stat-boost">5%</span> de ses PM pour chaque cible touchée par <strong>Éclatement</strong>.<br></p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lors de l'utilisation de la compétence <strong>Éclatement</strong>, l'effet <strong>Éclatement</strong> s'active à nouveau à l'emplacement de la première explosion.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Augmente les dégâts de feu de <span class="stat-boost">8%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque les PM de l'utilisateur sont supérieurs à <span class="stat-boost">51%</span>, son Attaque augmente à hauteur de <span class="stat-boost">60%</span> de ses PM.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Réduit le temps de rechargement d'<strong>Éclatement</strong> de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Augmente les PM max de <span class="stat-boost">400</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["orbe-d-avarice"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Les dégâts infligés par <strong>Purgatoire</strong> augmentent de <span class="stat-boost">50%</span> et la consommation de PM augmente de <span class="stat-boost">10%</span>.<br></p></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque l'utilisateur rejoint le niveau, applique 20 cumuls de l'effet <span class="buff">[Flamme noire tonitruante)</span>.<br>Augmente le temps de rechargement de <strong>Purgatoire</strong> de 5 seconde(s).<br></p><div class="detail-box"><h4><span class="buff">[Flamme noire tonitruante]</span></h4><p>Augmente les dégâts de <strong>Purgatoire</strong> de <span class="stat-boost">8%</span>.<br>Lorsque l'utilisateur lance <strong>Purgatoire</strong>, consomme 4 cumuls.<br>Durée: illimitée</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de feu augmentent de <span class="stat-boost">8%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Restaure les PM à hauteur des cumuls de <span class="buff">[Flamme noire tonitruante]</span> x 2 toutes les 3 seconde(s).<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Purgatoire</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Lorsque l'utilisateur rejoint le niveau, applique 30 cumuls de l'effet <span class="buff">[Flamme noire tonitruante]</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["tueuse-de-chevalier"] = {
    ...
    fullData: {
        ...
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Télékinésie</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Lorsque <span class="buff">[Décomposition]</span> explose avec le maximum de cumuls, l'effet <span class="buff">[Destruction amorcée]</span> s'applique sur la cible.<br></p><div class="detail-box"><h4><span class="buff">[Destruction amorcée]</span></h4><p>Les dégâts qu'elle subit augmentent de <span class="stat-boost">2%</span> (cumulable jusqu'à 5 fois).<br>Durée: infinie</p></div></div>`
    },
    summaryData: {
...
weaponsData["ame-de-phenix"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lors de l'utilisation de <strong>Tir rapide de phénix</strong>, l'effet <span class="buff">[Âme de l'oiseau de feu]</span> s'applique aux 3e, 6e et 9e flèches.<br>Lorsque l'Attaque de base de l'arme touche 3 fois sa cible, elle applique l'effet <span class="buff">[Âme de l'oiseau de feu]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Âme de l'oiseau de feu]</span></h4><p>L'Attaque de noyau de l'utilisateur devient <strong>Tir de flamme</strong>.<br>Augmente les dégâts de <strong>Tir de flamme</strong> de <span class="stat-boost">80%</span> par cumul d'âme de l'oiseau de feu (cumulable jusqu'à 3 fois).<br>Lors de l'utilisation de <strong>Tir de flamme</strong>, tous les cumuls d'âme de l'oiseau de feu sont consumés.<br>Durée: infinie</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Remplit <span class="stat-boost">34 %</span> de la jauge de noyau de l'utilisateur aux 3e, 6e et 9e flèches de <strong>Tir rapide de phénix</strong>.<br>Lorsque <strong>Tir de flamme</strong> touche sa cible, la jauge de noyau de l'utilisateur se remplit de <span class="stat-boost">50%</span>.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Augmente les dégâts de feu de l'utilisateur de <span class="stat-boost">10%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>La dernière flèche de <strong>Tir rapide de phénix</strong> octroie 2 cumuls de l'effet <span class="buff">[Âme de l'oiseau de feu]</span>.<br>Fait passer le maximum de cumuls de <strong>Tir de flamme</strong> à 4.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Réduit le temps de rechargement de <strong>Tir rapide de phénix</strong> de <span class="stat-boost">20%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Après l'obtention de l'effet <span class="buff">[Ame de l'oiseau de feu]</span> suite à l'utilisation de <strong>Tir rapide de phénix</strong> ou de l'Attaque de base, l'utilisateur récupère les cumuls consommés de l'effet <span class="buff">[Âme de l'oiseau de feu]</span> et <span class="stat-boost">100%</span> de sa jauge de noyau dès qu'il utilise <strong>Tir de flamme</strong>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["lance_a_double_lame_du_clan_radir"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>L'utilisation de la compétence <strong>Soutien du clan Radish</strong> applique 10 fois l'effet <span class="buff">[Moral]</span> sur l'utilisateur.<br></p><div class="detail-box"><h4><span class="buff">[Moral]</span></h4><p>Augmente les dégâts infligés de <span class="stat-boost">0.5 %</span>.<br>Durée : illimitée (cumulable jusqu'à 30 fois).</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque l'utilisateur touche une cible avec une attaque de feu, il applique 1 effet <span class="buff">[Moral]</span> (ne s'active qu'une fois lorsque l'attaque touche sa cible).<br>Lorsque l'utilisateur touche une cible avec une attaque de feu tout en ayant 30 cumuls de l'effet <span class="buff">[Moral]</span> appliqués, une petite zone <span class="buff">[Feu de soutien]</span> est créée autour de la cible (temps de rechargement : 10 seconde(s)).<br></p><div class="detail-box"><h4><span class="buff">[Feu de soutien]</span></h4><p>Inflige des dégâts élémentaires de feu équivalents à <span class="stat-boost">600 %</span> de l'Attaque de Sung Jinwoo.<br>Compte comme une compétence de base. Inflige des dégâts de Bris légers.</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Augmente les dégâts de feu de l'utilisateur de <span class="stat-boost">10 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque l'attaque de l'utilisateur touche une cible avec un effet Brûlure, l'effet <span class="buff">[Volonté brûlante]</span> est activé sur l'utilisateur (temps de rechargement : 2 seconde(s)).<br></p><div class="detail-box"><h4><span class="buff">[Volonté brûlante]</span></h4><p>Augmente les dégâts de feu de <span class="stat-boost">6 %</span>.<br>Augmente les Dégâts de coup critique de <span class="stat-boost">12 %</span>.<br>Durée : 15 seconde(s) (cumulable jusqu'à 5 fois).</p></div></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Diminue le temps de rechargement de <strong>Soutien du clan Radish</strong> de <span class="stat-boost">20 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>La portée d'attaque de <span class="buff">[Feu de soutien]</span> augmente de <span class="stat-boost">50 %</span>, et son temps de rechargement passe à 5 seconde(s).<br>Lorsqu'une attaque de feu de l'utilisateur touche une cible et si toutes les armes équipées sont de l'élément Feu, un cumul supplémentaire de l'effet <span class="buff">[Moral]</span> est activé (lorsque cette compétence touche sa cible, il ne s'active qu'une fois).<br>Améliore l'effet <span class="buff">[Moral]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Moral]</span> (Amélioré)</h4><p>Augmente les dégâts infligés de <span class="stat-boost">1.2 %</span>.<br>Augmente les dégâts de feu de la compétence de base de <span class="stat-boost">0.5 %</span> et les dégâts de la Compétences d'arme de <span class="stat-boost">1 %</span> lorsque toutes les armes équipées sont de l'élément Feu.<br>Durée : illimitée (cumulable jusqu'à 30 fois).</p></div></div>`
    },
    summaryData: {
