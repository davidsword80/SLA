...
huntersData["seo-jiwoo"] = {
    ...
    fullData: {
        ...
        1: `<h3>1 étoile :</h3><p>Les dégâts des compétences <strong>Attaque lourde: Ruade du dragon d'eau</strong> et <strong>Attaque lourde: Coup de pied foudroyant</strong> augmentent de <span class="stat-boost">150%</span>.<br></p>`,
        2: `<h3>2 étoiles :</h3><p>Augmente l'efficacité de <span class="buff">[Bris]</span> de l'utilisateur de <span class="stat-boost">15%</span>.<br>Augmente l'efficacité de <span class="buff">[Bris]</span> de la compétence <strong>Attaque lourde: Coup de pied foudroyant</strong> de l'utilisateur de <span class="stat-boost">50%</span>.<br></p>`,
        3: `<h3>3 étoiles :</h3><p>L'utilisateur récupère <strong>50 PM</strong> en appliquant <span class="buff">[Entraînement du dragon d'eau]</span>.<br></p>`,
        4: `<h3>4 étoiles :</h3><p>Les PV max de l'utilisatrice augmentent à hauteur de <span class="stat-boost">15%</span> de ses Dégâts de coup critique supplémentaires.<br></p>`,
        5: `<h3>5 étoiles :</h3><p>Le Taux de coup critique et les Dégâts de compétence de <strong>Attaque lourde : Ruade du dragon d'eau</strong>, <strong>Attaque lourde: Coup de pied foudroyant</strong> et <strong>Coup létal: Frappe de transformation du dragon d'eau</strong> augmentent de <span class="stat-boost">32%</span>.<br></p>`
    },
    summaryData: {
    ...
    weaponData: {
        0: `<h3>Avancement 0 :</h3><p>Augmente les dégâts de coup critique de l'utilisateur de <span class="stat-boost">5%</span>.<br>Lorsque l'utilisatrice lance <strong>Ruade du dragon d'eau</strong>, <strong>Coup de pied foudroyant</strong>, <strong>Attaque lourde: Ruade du dragon d'eau</strong> ou <strong>Attaque lourde: Coup de pied foudroyant</strong>, augmente les dégâts de coup critique de <span class="stat-boost">1%</span> (cumulable jusqu'à 20 fois).<br></p>`,
        1: `<h3>Avancement 5 étoiles :</h3><p>Augmente les dégâts de coup critique de l'utilisatrice de <span class="stat-boost">20%</span>.<br>Lorsque l'utilisatrice lance <strong>Ruade du dragon d'eau</strong>, <strong>Coup de pied foudroyant</strong>, <strong>Attaque lourde: Ruade du dragon d'eau</strong> ou <strong>Attaque lourde: Coup de pied foudroyant</strong>, augmente les dégâts de coup critique de <span class="stat-boost">6 %</span> (cumulable jusqu'à 20 fois).<br></p>`,
        2: `<h3>Avancement 10 étoiles :</h3><p>Augmente l'Attaque, la Défense et les PV de l'utilisateur de <span class="stat-boost">15%</span>.<br></p>`
    }
};
...
huntersData["meri-laine"] = {
    ...
    weaponData: {
        0: `<h3>Avancement 0 :</h3><p>Augmente les PV de l'utilisatrice de 5%.<br>Chaque fois que les compétences <strong>Balayage de lame</strong> ou <strong>Balayage enragé</strong> touchent leur cible, les dégats d' de toute L'équipe augmentent de 0.1%.<br>Durée: 45 seconde(s) (cumulable jusqu'à 50 fois)</p>`,
        1: `<h3>Avancement 5 étoiles :</h3><p>Augmente les PV de l'utilisatrice de 12%.<br>Chaque fois que les compétences <strong>Balayage de lame</strong> ou <strong>Balayage enragé</strong> touchent leur cible, les dégats d' de toute L'équipe augmentent de 0.6%.<br>Durée: 45 seconde(s) (cumulable jusqu'à 50 fois)</p>`,
        2: `<h3>Avancement 10 étoiles :</h3><p>Augmente L'attaque, la Défense et les PV de L'utilisatrice de 15%.</p>`
    }
};
...
huntersData["seo-lin"] = {
    ...
    fullData: {
        0: `<h3>Passif :</h3><p>Lorsque Seo Lin ou un allié parvient à mettre un ennemi en état de <span class="buff">[Bris]</span>, la durée de l'état de Bris augmente de 3 seconde(s).<br>Lorsque Seo Lin utilise les compétences <strong>Tornade glaçante</strong>, <strong>Déflagration polaire</strong>, <strong>Énorme éclat de glace</strong> ou <strong>Tornade congelante</strong>, l'effet <span class="buff">[Missile guidé]</span> est activé.<br></p><div class="detail-box"><h4><span class="buff">[Missile guidé]</span></h4><p><strong>Tornade glaçante</strong>, <strong>Énorme éclat de glace</strong> ou <strong>Tornade congelante</strong> tirent 2 missile(s).<br><strong>Déflagration polaire</strong> tire 4 missile(s).<br>Chaque missile inflige des dégâts d'eau équivalents à <span class="stat-boost">150%</span> des PV max de Seo Lin.<br>Applique l'effet <span class="buff">[En dessous de zéro]</span> à la cible.</p></div><div class="detail-box"><h4><span class="buff">[En dessous de zéro]</span></h4><p>Augmente les dégâts d'eau subis par la cible de <span class="stat-boost">1%</span>.<br>Durée : 30 seconde(s) (cumulable jusqu'à 10 fois).</p></div>`,
    ...
    weaponData: {
        0: `<h3>Avancement 0 :</h3><p>Augmente les PV de <span class="stat-boost">5%</span>.<br>Augmente les dégâts des missiles de <span class="stat-boost">30%</span>.</p>`,
        1: `<h3>Avancement 5 étoiles :</h3><p>Augmente les PV de <span class="stat-boost">12%</span>.<br>Augmente les dégâts des missiles de <span class="stat-boost">100%</span>.</p>`,
        2: `<h3>Avancement 10 étoiles :</h3><p>Augmente l'Attaque, la Défense et les PV de <span class="stat-boost">15%</span>.</p>`
    }
};
...
huntersData["Cha-hae-in-la-princesse-epeiste-immaculee"] = {
    ...
    weaponData: {
        0: `<h3>Avancement 0 :</h3><p>La Défense de l'utilisatrice augmente de <span class="stat-boost">2 %</span>.<br>Lorsque l'effet <span class="buff">[Volonté de l'épée]</span> s'active, la Défense augmente de <span class="stat-boost">1 %</span> (cumulable 60 fois).<br>Durée : illimitée.</p>`,
        1: `<h3>Avancement 5 étoiles :</h3><p>La Défense de l'utilisatrice augmente de <span class="stat-boost">12 %</span>.<br>Lorsque l'effet <span class="buff">[Volonté de l'épée]</span> s'active, la Défense augmente de <span class="stat-boost">6 %</span> (cumulable 60 fois).<br>Durée : illimitée.</p>`,
        2: `<h3>Avancement 10 étoiles :</h3><p>Augmente l'Attaque, la Défense et les PV de l'utilisatrice de <span class="stat-boost">15 %</span>.</p>`
    }
};
