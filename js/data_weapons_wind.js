...
weaponsData["epee-du-chevalier"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lors de l'utilisation de la compétence <strong>Épéiste royal : Épée du jugement</strong>, l'effet <span class="buff">[Chevalerie]</span> est appliqué.<br></p><div class="detail-box"><h4><span class="buff">[Chevalerie]</span></h4><p>Augmente la Défense de l'utilisateur de <span class="stat-boost">400</span> (cumulable jusqu'à 7 fois).<br>Durée : 15 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Augmente l'Attaque de l'utilisateur de <span class="stat-boost">400</span> lorsque l'effet <span class="buff">[Chevalerie]</span> se cumule 3 fois.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Les dégâts de vent infligés par l'utilisateur augmentent de <span class="stat-boost">6 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque l'effet <span class="buff">[Chevalerie]</span> se cumule 5 fois, l'utilisateur récupère des PV à hauteur de <span class="stat-boost">20</span> pour chaque ennemi touché par la compétence.<br>(Temps de rechargement : 0.5 seconde(s))</p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Réduit le temps de rechargement de la compétence <strong>Épéiste royal : Épée du jugement</strong> de <span class="stat-boost">10 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Applique l'effet <span class="buff">[Purification]</span> toutes les 10 secondes lorsque l'effet <span class="buff">[Chevalerie]</span> se cumule 7 fois.<br>La durée de <span class="buff">[Chevalerie]</span> devient illimitée.</p></div>`
    },
    summaryData: {
...
weaponsData["epee-de-kim-sangshink"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque la compétence <strong>Énergie d'épée à 3 millions de wons</strong> est utilisée, l'effet <span class="buff">[Un nouveau départ]</span> s'applique.<br></p><div class="detail-box"><h4><span class="buff">[Un nouveau départ]</span></h4><p>La Vitesse d'attaque et la Vitesse de l'utilisateur augmentent de <span class="stat-boost">12 %</span>.<br>Durée : 8 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque les PV de l'utilisateur sont supérieurs à <span class="stat-boost">70 %</span>, applique l'effet <span class="buff">[Taux de coup critique augmenté]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Taux de coup critique augmenté]</span></h4><p>Augmente le Taux de coup critique de <span class="stat-boost">8 %</span>.</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de vent augmentent de <span class="stat-boost">6 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque l'effet <span class="buff">[Un nouveau départ]</span> est appliqué, un <span class="buff">[Bouclier]</span> équivalent à <span class="stat-boost">50 %</span> de la Défense de l'utilisateur est créé.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Réduit le temps de rechargement de la compétence <strong>Énergie d'épée à 3 millions de wons</strong> de <span class="stat-boost">10 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Lorsque l'effet <span class="buff">[Un nouveau départ]</span> est appliqué, les dégâts des Attaques de base et de noyau augmentent de <span class="stat-boost">50 %</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["vent-d-ouest"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>S'il n'y a aucune cible dans un rayon de 5 m, les dégâts de la compétence <strong>Balle secrète</strong> lancée par l'utilisateur augmentent de <span class="stat-boost">75%</span>.<br></p></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Modification des effets de la compétence <strong>Balle secrète</strong>.<br>Il s'agit désormais d'une compétence à effet de charge.<br>Les dégâts augmentent de <span class="stat-boost">130 %</span> maximum suivant le temps passé à la charger.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de vent augmentent de <span class="stat-boost">8 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque <strong>Balle secrète</strong> touche sa cible, elle applique l'effet <span class="buff">[Vent d'ouest]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Vent d'ouest]</span></h4><p>Augmente les dégâts de la compétence <strong>Balle secrète</strong> de <span class="stat-boost">30%</span> (cumulable jusqu'à 5 fois).<br>Si la compétence <strong>Balle secrète</strong> manque sa cible, tous les cumuls sont annulés.<br>Durée: 30 seconde(s) (Temps de rechargement: 10 seconde(s))</p></div></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Balle secrète</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Lorsque <strong>Balle secrète</strong> inflige un Coup critique, le temps de rechargement diminue de 9 seconde(s) (Temps de rechargement: 10 seconde(s)).<br></p></div>`
    },
    summaryData: {
...
weaponsData["surine-de-baruka"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lors de l'utilisation de la compétence <strong>Tueur de marcheurs blancs</strong>, l'utilisateur applique l'effet <span class="buff">[Vivacité]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Vivacité]</span></h4><p>Augmente les dégâts des attaques dans le dos de <span class="stat-boost">30%</span>.<br>Durée: 8 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Modification des effets de <strong>Tueur de marcheurs blancs</strong>:<br>Lorsque cette compétence touche sa cible, l'utilisateur se téléporte derrière elle.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de vent augmentent de <span class="stat-boost">8 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque l'utilisateur réussit une attaque dans le dos, il applique l'effet <span class="buff">[Attaque surprise]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Attaque surprise]</span></h4><p>Augmente le Taux de coup critique de <span class="stat-boost">20%</span>.<br>Durée: 5 seconde(s)<br>Temps de rechargement: 5 seconde(s)</p></div></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Tueur de marcheurs blancs</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Fait passer le Taux de coup critique de l'effet <strong>Attaque surprise</strong> à <span class="stat-boost">40%</span>.<br>Lorsque la compétence <strong>Foulée de l'ombre</strong> est utilisée, elle applique les effets <span class="buff">[Vivacité et Attaque surprise]</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["marteau-de-golem-de-roche"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lors de l'utilisation de la compétence <strong>Destruction terrestre</strong>, l'effet <span class="buff">[Protection terrestre]</span> est appliqué.<br></p><div class="detail-box"><h4><span class="buff">[Protection terrestre]</span></h4><p>Crée un <span class="buff">[Bouclier]</span> équivalent à <span class="stat-boost">40%</span> de la Défense de l'utilisateur.<br>Durée: 4 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Modification de l'effet <span class="buff">[Protection terrestre]</span><br>L'effet de <span class="buff">[Bouclier]</span> bénéficie d'une augmentation équivalente à <span class="stat-boost">80%</span> de la Défense.<br>Augmente sa durée à 6 seconde(s).<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts de vent augmentent de <span class="stat-boost">8 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque l'effet <span class="buff">[Protection terrestre]</span> est actif, il applique aussi l'effet <span class="buff">[Tempête terrestre]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Tempête terrestre]</span></h4><p>L'utilisateur invoque un rocher qui inflige des dégâts équivalents à <span class="stat-boost">200%</span> de sa Défense dans un rayon de 5 m toutes les secondes.<br>Durée: 10 seconde(s)</p></div></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Destruction terrestre</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Pendant que l'effet <span class="buff">[Bouclier]</span> est actif, l'Attaque augmente de <span class="stat-boost">10%</span> et la Défense de <span class="stat-boost">10%</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["voeu-de-fores"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque l'attaque de noyau touche sa cible, l'utilisateur reçoit l'effet <span class="buff">[Vœu]</span>.</p><div class="detail-box"><h4><span class="buff">[Vœu]</span></h4><p>Augmente les dégâts infligés de <span class="stat-boost">20%</span>.<br>Lorsque la compétence <strong>Chant de l'arbre du vent</strong> touche sa cible, l'effet <span class="buff">[Vœu]</span> est supprimé.<br>Durée: 20 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque l'utilisateur rejoint un niveau, sa jauge de noyau est chargée à <span class="stat-boost">100%</span>.</p><p>Améliore l'effet <span class="buff">[Vœu]</span> : augmente les dégâts infligés de <span class="stat-boost">20%</span>. Lorsque <strong>Chant de l'arbre du vent</strong> touche sa cible, l'utilisateur a <span class="stat-boost">100%</span> de chances d'activer son attaque de noyau (CD: 20s).</p><p>L'utilisateur reçoit également l'effet <span class="buff">[Détachement]</span> lors de l'utilisation de la compétence.</p><div class="detail-box"><h4><span class="buff">[Détachement]</span></h4><p>Lorsque l'attaque de noyau touche sa cible, le temps de rechargement de <strong>Chant de l'arbre du vent</strong> est réinitialisé (CD: 20s).<br>L'effet est supprimé après activation. Durée: 20 seconde(s)</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Les dégâts élémentaires de vent de l'utilisateur augmentent de <span class="stat-boost">10%</span>.</p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>L'effet <span class="buff">[Vœu]</span> est amélioré : augmente les dégâts infligés de <span class="stat-boost">40%</span>.</p><p>L'attaque de noyau inflige des dégâts supplémentaires équivalents à <span class="stat-boost">500%</span> de l'Attaque à la première cible.</p><p>Lorsque <strong>Chant de l'arbre du vent</strong> touche sa cible, l'effet <span class="buff">[Dispersion racinaire]</span> s'active (dégâts zone <span class="stat-boost">100%</span> Atk) et applique <span class="buff">[Poison]</span>.</p><div class="detail-box"><h4><span class="buff">[Empoisonnement]</span></h4><p>Inflige des dégâts équivalents à <span class="stat-boost">50%</span> de l'Attaque toutes les 3s.<br>Diminue le Taux de récupération de la cible de <span class="stat-boost">70%</span>. Durée: 30s</p></div></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Chant de l'arbre du vent</strong> diminue de <span class="stat-boost">20%</span>.</p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Les dégâts de <strong>Chant de l'arbre du vent</strong> augmentent de <span class="stat-boost">50%</span>.</p><p>Les dégâts de <span class="buff">[Dispersion racinaire]</span> augmentent de <span class="stat-boost">150%</span>.</p></div>`
    },
    summaryData: {
