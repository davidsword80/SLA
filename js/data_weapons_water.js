...
weaponsData["arc-d-elfe-des-glaces"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque la compétence <strong>Explosion glacée</strong> touche sa cible, elle lui applique l'effet <span class="buff">[Gel]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Gel]</span></h4><p>Cette compétence interrompt la cible.<br>Durée : <span class="stat-boost">0,5</span> seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>La durée de l'effet <span class="buff">[Gel]</span> provoqué par <strong>Explosion glacée</strong> augmente de <span class="stat-boost">1</span> seconde(s).<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts d'eau augmentent de <span class="stat-boost">6 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>La portée de la compétence <strong>Explosion glacée</strong> augmente de <span class="stat-boost">25 %</span>.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de la compétence <strong>Explosion glacée</strong> diminue de <span class="stat-boost">10 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Lorsque la compétence <strong>Explosion glacée</strong> touche sa cible, elle lui applique l'effet <span class="buff">[Engelure]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Engelure]</span></h4><p>Inflige des dégâts équivalents à <span class="stat-boost">50 %</span> de l'Attaque toutes les 3 seconde(s) (cumulable jusqu'à 5 fois).<br>Après 5 cumuls, la compétence applique l'effet <span class="buff">[Gel]</span> à la cible pendant <span class="stat-boost">2</span> seconde(s).<br>Durée : 30 seconde(s)</p></div></div>`
    },
    summaryData: {
...
weaponsData["glaive-de-lezard"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lors de l'utilisation de la compétence <strong>Transpercement de lézard</strong>, l'utilisateur applique l'effet <span class="buff">[Protection de lézard]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Protection de lézard]</span></h4><p>Les dégâts de la compétence <strong>Transpercement de lézard</strong> augmentent de <span class="stat-boost">0.3 %</span> (cumulable jusqu'à 999 fois).<br>Durée : infinie</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lors de l'utilisation de la compétence <strong>Transpercement de lézard</strong>, l'utilisateur a <span class="stat-boost">80 %</span> de chances de réinitialiser son temps de rechargement.<br>Réduit le prochain taux de réinitialisation du temps de rechargement en cas de réussite.</p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts d'eau augmentent de <span class="stat-boost">6 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>L'effet <strong>Protection de lézard</strong> s'active tous les 2 cumuls.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Transpercement de lézard</strong> diminue de <span class="stat-boost">10 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Les dégâts infligés aux monstres de type Boss avec <strong>Transpercement de lézard</strong> augmentent de <span class="stat-boost">40 %</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["crochet-venimeux"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Il y a <span class="stat-boost">30%</span> de chances d'appliquer l'effet <span class="buff">[Hémorragie]</span> à la cible lorsque le compétence <strong>Vile attaque sournoise</strong> la touche.<br></p><div class="detail-box"><h4><span class="buff">[Hémorragie]</span></h4><p>Inflige des dégâts équivalents à <span class="stat-boost">0.8%</span> des PV actuels de la cible toutes les 3 seconde(s).<br>Durée: 30 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque la compétence <strong>Attaque de noyau</strong> ou <strong>Vile attaque sournoise</strong> touche sa cible, elle a <span class="stat-boost">30%</span> de chances de lui appliquer l'effet <span class="buff">[Paralysie]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Paralysie]</span></h4><p>Cette compétence interrompt la cible.<br>Durée: 1 seconde(s)</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts d'eau augmentent de <span class="stat-boost">8 %</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Ajoute l'effet <span class="buff">[Venin de Kasaka]</span> à la compétence <strong>Vile attaque sournoise</strong>.<br></p><div class="detail-box"><h4><span class="buff">[Poison de Kasaka]</span></h4><p>Crée une flaque de venin au sol pendant 5 secondes qui inflige des dégâts supplémentaires aux cibles se trouvant dans la zone.</p></div></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Vile attaque sournoise</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Applique l'effet <span class="buff">[Poison mortel de Kasaka]</span> aux cibles touchées par <strong>Vile attaque sournoise</strong>.<br></p><div class="detail-box"><h4><span class="buff">[Poison mortel de Kasaka]</span></h4><p>L'utilisateur inflige des dégâts équivalents à <span class="stat-boost">75%</span> de l'Attaque toutes les 3 seconde(s).<br>Réduit le Taux de récupération des PV de la cible de <span class="stat-boost">70%</span>.<br>Durée: 30 seconde(s)</p></div></div>`
    },
    summaryData: {
...
weaponsData["fauchon-gele"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque la compétence <strong>Bourrasque glaciale</strong> touche sa cible, elle a <span class="stat-boost">20%</span> de chances de lui appliquer l'effet <span class="buff">[Gel]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Gel]</span></h4><p>Cette compétence interrompt la cible.<br>Durée: 2 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque la compétence <strong>Bourrasque glaciale</strong> est utilisée sur des cibles affectées par <span class="buff">[Gel]</span>, l'effet <span class="buff">[Érosion]</span> s'applique.<br></p><div class="detail-box"><h4><span class="buff">[Érosion]</span></h4><p>Augmente les dégâts infligés aux cibles dotées d'une faiblesse élémentaire de <span class="stat-boost">12%</span>.<br>Durée: 15 seconde(s)</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts d'eau augmentent de <span class="stat-boost">8%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Modification des effets de la compétence <span class="buff">[Bourrasque glaciale]</span>: Peut être utilisée jusqu'à 2 fois Réduit le temps de rechargement de 3 seconde(s).<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <span class="buff">[Bourrasque glaciale]</span> diminue de <span class="stat-boost">15 %</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>L'effet <span class="buff">[Erosion]</span> peut se cumuler jusqu'à 2 fois.<br></p></div>`
    },
    summaryData: {
...
weaponsData["trident-de-dragon-gardien-naga"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque qu'une attaque de base est portée, elle a <span class="stat-boost">75%</span> de chances de créer des explosions d'eau supplémentaires devant l'utilisateur.<br></p></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque la compétence <strong>Tsunami naga</strong> est utilisée, elle projette 3 déferlements d'eau supplémentaires.<br>Inflige des dégâts équivalents à <span class="stat-boost">120%</span> de l'Attaque de l'utilisateur à chaque explosion.<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts d'eau augmentent de <span class="stat-boost">8%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsqu'une Attaque de noyau est utilisée, elle projette 3 déferlements d'eau supplémentaires.<br>Inflige des dégâts équivalents à <span class="stat-boost">120%</span> de l'Attaque de l'utilisateur à chaque explosion.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Tsunami naga</strong> diminue de <span class="stat-boost">15%</span>.<br></p></div>`,
...
weaponsData["grimoire-de-thetis"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque la compétence <strong>Jet d'eau</strong> touche sa cible, elle a <span class="stat-boost">100%</span> de chances de lui appliquer l'effet <span class="buff">[Glace gelée]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Glace gelée]</span></h4><p>Applique l'effet <span class="buff">[Gel]</span> à la cible et l'interrompt.<br>Lorsque cet effet expire, il inflige des dégâts supplémentaires équivalents à <span class="stat-boost">10%</span> des dégâts subis pendant la durée de l'effet.<br>Durée: 4 seconde(s)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>L'effet <span class="buff">[Erosion profonde]</span> s'applique également aux cibles affectées par l'effet <span class="buff">[Glace gelée]</span>.<br></p><div class="detail-box"><h4><span class="buff">[Érosion profonde]</span></h4><p>Augmente les dégâts de Faiblesse élémentaire subis par l'ennemi de <span class="stat-boost">24%</span>.<br>Durée: 15 seconde(s)</p></div></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Vos dégâts d'eau augmentent de <span class="stat-boost">10%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque l'effet <span class="buff">[Glace gelée]</span> expire, les dégâts supplémentaires de l'utilisateur passent à <span class="stat-boost">20%</span>.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Le temps de rechargement de <strong>Jet d'eau</strong> diminue de <span class="stat-boost">20%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Les dégâts infligés aux cibles affectées par <span class="buff">[Gel]</span> augmentent de <span class="stat-boost">50%</span>.<br></p></div>`
    },
    summaryData: {
...
weaponsData["planche-de-surf-marlin"] = {
    ...
    fullData: {
        0: `<div class="passif-content passif-block"><h3>Passif :</h3><p>Lorsque la compétence <strong>Rêve de marlin</strong> est utilisée à la suite de <strong>Ruée</strong>, elle devient <strong>Marlin volant</strong> et augmente les dégâts de l'utilisateur de <span class="stat-boost">30%</span>.<br>Lorsque les compétences <strong>Rêve de marlin</strong> ou <strong>Marlin volant</strong> touchent leur cible, l'effet <span class="buff">[Voie du surfeur]</span> est appliqué.<br>Lorsque les compétences <strong>Rêve de marlin</strong> ou <strong>Marlin volant</strong> sont utilisées, l'effet <span class="buff">[Super armure]</span> est appliqué.<br></p><div class="detail-box"><h4><span class="buff">[Voie du surfeur]</span></h4><p>Augmente les dégâts face aux monstres de type Normal de <span class="stat-boost">1%</span>.<br>Durée: infinie (cumulable jusqu'à 999 fois)</p></div></div>`,
        1: `<div class="passif-content star-block"><h3>1 étoile :</h3><p>Lorsque la compétence <strong>Rêve de marlin</strong> est utilisée à la suite de <strong>Ruée</strong>, le temps de rechargement des compétences <strong>Rêve de marlin</strong> et <strong>Marlin volant</strong> se réinitialise (temps de rechargement: 30 seconde(s)).<br></p></div>`,
        2: `<div class="passif-content star-block"><h3>2 étoiles :</h3><p>Les dégâts d'eau de l'utilisateur augmentent de <span class="stat-boost">10%</span>.<br></p></div>`,
        3: `<div class="passif-content star-block"><h3>3 étoiles :</h3><p>Lorsque la compétence <strong>Marlin volant</strong> est utilisée, la compétence <strong>Ruée</strong> se charge 1 fois.<br>Augmente les dégâts des compétences <strong>Rêve de marlin</strong> et <strong>Marlin volant</strong> de <span class="stat-boost">30%</span>.<br></p></div>`,
        4: `<div class="passif-content star-block"><h3>4 étoiles :</h3><p>Réduit le temps de rechargement des compétences <strong>Rêve de marlin</strong> et <strong>Marlin volant</strong> de <span class="stat-boost">20%</span>.<br></p></div>`,
        5: `<div class="passif-content star-block"><h3>5 étoiles :</h3><p>Lorsque l'utilisateur terrasse un ennemi avec <strong>Rêve de marlin</strong> ou <strong>Marlin volant</strong>, l'effet <span class="buff">[Shaka]</span> est appliqué.<br></p><div class="detail-box"><h4><span class="buff">[Shaka]</span></h4><p>Augmente l'Attaque de l'utilisateur de <span class="stat-boost">1%</span>.<br>Durée: infinie (cumulable jusqu'à 20 fois)</p></div></div>`
    },
    summaryData: {
