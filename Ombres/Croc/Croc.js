...
/* ==========================================
   LOGIQUE ARME (Orbe d'avarice) - 1 ÉTOILE
   ========================================== */
...
const passifTexte = `
    <p>Les ennemis ayant <span class="stat-boost">50% de PV ou moins</span> subissent <span class="stat-boost">8%</span> de dégâts en plus lorsqu'ils sont touchés par l'ombre.<br></p>
`;
