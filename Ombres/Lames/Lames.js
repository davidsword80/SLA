...
/* ==========================================
   LOGIQUE ARME (Surin - Reproduction) - 1 ÉTOILE
   ========================================== */
...
const passifTexte = `
    <p>L'Attaque de l'ombre augmente de <span class="stat-boost">2.5%</span> et sa Pénétration de défense de <span class="stat-boost">2.5%</span>.<br></p>
`;
