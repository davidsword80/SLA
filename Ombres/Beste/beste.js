...
const shadowData = {
    0: `
        <h3>Rang : Commun</h3>
        <p>La Pénétration de défense de toute l'équipe augmente de <span class="stat-boost">4%</span>.<br></p>
    `,
    1: `
        <h3>Rang : Général</h3>
        <p>La Pénétration de défense de toute l'équipe augmente de <span class="stat-boost">8%</span>.<br></p>
    `
};
...
/* ==========================================
   LOGIQUE ARME (Grimoire de Thétis) - 1 ÉTOILE
   ========================================== */
...
const passifTexte = `
    <p>L'Attaque de l'ombre augmente de <span class="stat-boost">4%</span>.<br>
    Les dégâts de la compétence de base de l'ombre augmentent de <span class="stat-boost">2.5%</span>.<br></p>
`;
