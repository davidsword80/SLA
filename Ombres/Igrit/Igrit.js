...
/* ==========================================
   LOGIQUE ARME (Glaive - Reproduction) - 1 ÉTOILE
   ========================================== */
...
const passifTexte = `
    <p>Le Taux de coup critique et les Dégâts de coup critique de l'ombre augmentent de <span class="stat-boost">2.5%</span>.<br></p>
`;
